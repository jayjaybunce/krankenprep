...
func main() {
	...
	protected.Use(middleware.AuthMiddleware())
	{
		...
		protected.GET("/teams/:teamId/loot/tier-sim/refresh-config", handlers.GetTierSimRefreshConfig)
		protected.PUT("/teams/:teamId/loot/tier-sim/refresh-config", handlers.UpdateTierSimRefreshConfig)
		protected.POST("/teams/:teamId/loot/tier-sim/refresh", handlers.RefreshTierSimData)
